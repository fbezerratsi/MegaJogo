    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span6 bloco1">
                ...
                <!-- <div id="centro">
                     <div id="slide">
                       ...
                       <div id="paginasSlide">
                             <div id="btAnt"><img src="img/Previous-256.png" width="35"/></div>
                             <div id="pagerSlide"></div>
                             <div id="btProx"><img src="img/Next-256.png" width="35"/></div>
                         </div>
            ...
            <div class="span4 offset2 bloco2">
                ...
                ?>
                <h1>Ranking: <h6><?php echo "Rodada " . $vetor["id"] . ": " . $vetor["nome"] . " " . $vetor["descricao"]; ?></h6></h1>
