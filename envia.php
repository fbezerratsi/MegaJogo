...
$smtp->user = "solutionsforinternet@gmail.com";  //Conta de email
$smtp->pass = "59343000"; //Senha da Conta de e-mail.
...
$to = "felipe.musicrn@gmail.com"; //Informe aqui o e-mail que deve receber a mensagem do formulário.
$from = $email;
	...
	if (isset($_POST['submit'])) {
		if($nome && $email && $assunto && $mensagem) {
				if($smtp->Send($to, $from, $subject, $msg)){
					...
					//echo "<script>window.location = '.php';</script>"; //Altere aqui para o endereço de sua página.
					exit;
				}
	   }
